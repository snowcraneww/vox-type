...
- 2026-06-01 V7 ???????????????????????????? `docs/superpowers/specs/2026-06-01-v7-model-routing-design.md` ? `docs/superpowers/plans/2026-06-01-v7-model-routing.md`?V7 ??????????????????????MiniMax UI ???????? `lm_id`????? metadata????? WebSocket ???????? V8?

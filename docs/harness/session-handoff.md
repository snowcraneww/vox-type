...
## 2026-06-03 V9 closeout and V9.5 handoff

- `v9-001` is now `passing`. Maintainer verified recognition history delete/retention and confirmed low-volume, far-microphone, and clipping warnings are useful.
- The noisy silence warning was fixed by tightening `mostly_silence` to very high silence ratio plus very short active speech.

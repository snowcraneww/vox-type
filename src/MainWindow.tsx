      ...
      <section className="control-center v51" aria-labelledby="app-title">
        ...
        <div className="v51-top-grid">
          <section className="control-section mode-selector" aria-label="输入模式">
            ...
            <article className="mode-card compact" title="按住快捷键说一句，松开后转写并上屏。"><div className="mode-line"><h2>按住说话</h2><kbd>Ctrl+Alt+Space</kbd><span className="ready-dot" data-ready={hotkeysReady} title={hotkeysReady ? '快捷键已注册' : '快捷键未注册'} aria-label={hotkeysReady ? '快捷键已注册' : '快捷键未注册'} /></div><div className="mode-card-actions"><button className="icon-only-button" type="button" disabled title="下一版支持自定义快捷键" aria-label="修改按住说话快捷键">⚙</button></div></article>
            <article className="mode-card compact" title="按一次开始，录音中分段上屏，再按一次停止。"><div className="mode-line"><h2>连续输入</h2><kbd>{toggleHotkey}</kbd><span className="ready-dot" data-ready={hotkeysReady} title={hotkeysReady ? '快捷键已注册' : '快捷键未注册'} aria-label={hotkeysReady ? '快捷键已注册' : '快捷键未注册'} /></div><div className="mode-card-actions"><button className="icon-only-button" type="button" disabled title="下一版支持自定义快捷键" aria-label="修改连续输入快捷键">⚙</button></div></article>
          </section>
